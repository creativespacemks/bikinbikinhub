...
(() => {
    var V,
                ...
                for (; e && e.nodeType !== 9;) {
                    var a = e,
                        i = a.id
                            ...
                            (a.classList &&
                                a.classList.value &&
                                a.classList.value.trim() &&
                                a.classList.value.trim().length
                                ? "." + a.classList.value.trim().replace(/\s+/g, ".")
                                : "");
        ...
        g = function (e, t) {
            ...
            return (
                se() >= 0
                    ...
                    : r &&
                    (document.prerendering || _() > 0
                        ? (a = "prerender")
                        : document.wasDiscarded
                            ? (a = "restore")
                            : r.type && (a = r.type.replace(/_/g, "-"))),
                {
                    name: e,
                    value: t === void 0 ? -1 : t,
                    rating: "good",
        ...
        k = function (e, t, r) {
            try {
                if (PerformanceObserver.supportedEntryTypes.includes(e)) {
                    ...
                    return (
                        a.observe(Object.assign({ type: e, buffered: !0 }, r || {})), a
                    );
                }
            } catch { }
        },
        ...
        B = function (e) {
            document.visibilityState === "hidden" &&
                b > -1 &&
                ((b = e.type === "visibilitychange" ? e.timeStamp : 0), Fe());
        },
        ee = function () {
            ...
            (t = t || {}),
                z(function () {
                    var r,
                        a = ce(),
                        i = g("FCP"),
                        n = k("paint", function (o) {
                            o.forEach(function (s) {
                                s.name === "first-contentful-paint" &&
                                    (n.disconnect(),
                                        s.startTime < a.firstHiddenTime &&
                                        ((i.value = Math.max(s.startTime - _(), 0)),
                                            i.entries.push(s),
                                            r(!0)));
                            });
                        });
        ...
        de = function (e, t) {
            (function (r, a) {
                                    ...
                                    l.forEach(function (c) {
                                        if (!c.hadRecentInput) {
                                            var f = s[0],
                                                h = s[s.length - 1];
                                            o &&
                                                c.startTime - h.startTime < 1e3 &&
                                                c.startTime - f.startTime < 5e3
                                                ? ((o += c.value), s.push(c))
                                                : ((o = c.value), (s = [c]));
                                        }
                                    }),
                                        o > n.value && ((n.value = o), (n.entries = s), i());
                                },
                                d = k("layout-shift", u);
                            d &&
                ...
                var a = (function (i) {
                    ...
                    return Object.assign(i, { attribution: o });
                })(r);
                e(a);
            }, t);
        },
        le = function (e, t) {
            ue(function (r) {
                var a = (function (i) {
                    ...
                    return Object.assign(i, { attribution: n });
                })(r);
                e(a);
            }, t);
        },
        ...
        K = function (e) {
            ...
            return (
                (e = Z(e)),
                document.visibilityState === "hidden" ? e() : ((r = t(e)), W(e)),
                r
            );
        },
        re = [200, 500],
                        ...
                        var a,
                            ...
                            n = function (s) {
                                K(function () {
                                    ...
                                    u &&
                                        u.latency !== i.value &&
                                        ((i.value = u.latency), (i.entries = u.entries), a());
                                });
                            },
                            o = k("event", n, {
                                durationThreshold:
                                    (r = t.durationThreshold) !== null && r !== void 0 ? r : 40,
                            });
    ...
    ge.push(
        function (e) {
            e.interactionId &&
                e.target &&
                !C.has(e.interactionId) &&
                C.set(e.interactionId, e.target);
        },
        function (e) {
            var t,
    ...
    var he = function (e, t) {
                ...
                _e(function (r) {
                    var a = (function (i) {
                        var n = i.entries[0],
                            ...
                            h = [n.startTime + n.duration, u].concat(
                                l.map(function (E) {
                            ...
                            Le = {
                                ...
                                interactionType: n.name.startsWith("key")
                                    ? "keyboard"
                                    : "pointer",
                        ...
                        return Object.assign(i, { attribution: Le });
                    })(r);
                    e(a);
                }, t);
        },
                                ...
                                a.reportAllChanges || (l = l.slice(-1)),
                                    l.forEach(function (c) {
                                        c.startTime < n.firstHiddenTime &&
                                            ((o.value = Math.max(c.startTime - _(), 0)),
                                                (o.entries = [c]),
                                                i());
                                    });
                            },
                            u = k("largest-contentful-paint", s);
                        if (u) {
                            i = v(r, o, ie, a.reportAllChanges);
                            var d = Z(function () {
                                H[o.id] ||
                                    (s(u.takeRecords()), u.disconnect(), (H[o.id] = !0), i(!0));
                            });
                    ...
                    if (i.entries.length) {
                        ...
                        if (o) {
                            var s = o.activationStart || 0,
                                ...
                                d =
                                    u.url &&
                                    performance.getEntriesByType("resource").filter(function (x) {
                                        return x.name === u.url;
                                    })[0],
        ...
        Ne = function (e, t) {
            ...
            Oe(function () {
                var i = P();
                i &&
                    ((r.value = Math.max(i.responseStart - _(), 0)),
                        (r.entries = [i]),
                        a(!0),
                        M(function () {
                            (r = g("TTFB", 0)), (a = v(e, r, ae, t.reportAllChanges))(!0);
                        }));
            });
        },
        Se = function (e, t) {
    ...
    var m = class {
        ...
        serialize() {
            return {
                source: "framer.site",
                timestamp: Date.now(),
                data: { type: "track", uuid: He(), event: this.event, ...this.data },
            };
        }
    };
    function we(e) {
        ...
        let r = new Set(
            ...
            ].filter((n) => n.name.startsWith("framer-"))
        );
        ...
        let a = document.getElementById("main").dataset,
            i = {
                pageOptimizedAt: a.framerPageOptimizedAt
                    ? new Date(a.framerPageOptimizedAt).getTime()
                    : null,
                ssrReleasedAt: a.framerSsrReleasedAt
                    ? new Date(a.framerSsrReleasedAt).getTime()
                    : null,
    ...
    function be(e, t, r, a) {
        ...
        if (
            (Ee || (i.push(Ve(r)), (Ee = !0)),
                e.size > 0 && (i.push(...je(e, r)), e.clear()),
                t.size > 0)
        ) {
            let n = Ue(t);
            n && i.push(n), t.clear();
    ...
    function Ve({
        ...
        return new m("published_site_performance", {
            ...
            pageLoadDurationMs:
                (n == null ? void 0 : n.domContentLoadedEventEnd) !== void 0 &&
                    n.domContentLoadedEventStart !== void 0
                    ? Math.round(
            ...
            framerCSSSize:
                (u = o == null ? void 0 : o.textContent) == null ? void 0 : u.length,
            ...
            connection: S({
                ...
                downlinkMax:
                    (l = navigator.connection) == null ? void 0 : l.downlinkMax,
            ...
            context: { origin: r, pathname: a, search: i },
        });
    }
    function je(
        e,
        { pageOptimizedAt: t, ssrReleasedAt: r, origin: a, pathname: i, search: n }
    ) {
        let o = [];
        return (
            e.forEach((s) => {
                ...
                let { name: u, delta: d, id: l, attribution: c } = s,
                    f = {
                        ...
                        pageOptimizedAt: t,
                        ssrReleasedAt: r,
                        context: { origin: a, pathname: i, search: n },
                    ...
                    : u === "CLS"
                        ...
                        : u === "INP"
                            ? (f.attributionInp = S({
                                ...
                                eventTime: c.interactionTime
                                    ? Math.round(c.interactionTime)
                                    : void 0,
                                loadState: c.loadState,
    ...
    function Ue(e) {
        ...
        if (
            (e.forEach((r) => {
                e.delete(r);
                let a = { name: r.name, startTime: r.startTime, duration: r.duration };
                t.push(a);
            }),
                t.length !== 0)
        )
    ...
    async function N(e = { priority: "background" }) {
        if (window.scheduler) {
            if (window.scheduler.yield) return window.scheduler.yield(e);
    ...
    function Ce(e) {
        ...
        history.pushState = function (...r) {
            t.apply(history, r), (async () => (await N(), I(e)))();
        };
    }
    function Pe(e) {
    ...
    var L = "__framer_events";
    function Me(e) {
        if ((window[L] || (window[L] = []), window[L].length > 0)) {
            let t = window[L].map((r) => new m(r[0], r[1]));
            e(t), (window[L].length = 0);
        }
        window[L].push = function (...t) {
    ...
    function Ke(e) {
        ...
        fetch(Ze, {
            body: JSON.stringify(
                e.map((r) => ({
                    ...r,
                    data: { ...r.data, context: { ...t, ...r.data.context } },
                }))
            ),
            method: "POST",
            keepalive: !0,
    ...
    var Xe = async () => {
        await N(), we(F), Ce(F), Pe(F), Me(F);
        let e = typeof document.referrer == "string";
        I(F, { initialReferrer: (e && document.referrer) || null });
    };
    Xe();
})();
