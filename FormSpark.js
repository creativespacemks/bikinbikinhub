 ...
 */ const FormSpark = withCSS(
  function FormSpark ({
    ...
    const [nameValue, setName] = useState(
      name === null || name === void 0 ? void 0 : name.value
    )
    const [emailValue, setEmail] = useState(
      email === null || email === void 0 ? void 0 : email.value
    )
    const [messageValue, setMessage] = useState(
      message === null || message === void 0 ? void 0 : message.value
    )
                      ...
                      /*#__PURE__*/ _jsx('input', {
                        ...
                        style: {
                          ...
                          boxShadow: `inset 0 0 0 1px ${
                            isNameError ? inputs.error : 'transparent'
                          }`
                        }
                      }),
                    withEmail &&
                      /*#__PURE__*/ _jsx('input', {
                        ...
                        style: {
                          ...
                          color: inputs.color,
                          boxShadow: `inset 0 0 0 1px ${
                            isEmailError ? inputs.error : 'transparent'
                          }`
                        }
                      })
                  ]
              ...
              withMessage &&
                /*#__PURE__*/ _jsx('textarea', {
                  ...
                  style: {
                    ...
                    color: inputs.color,
                    boxShadow: `inset 0 0 0 1px ${
                      isMessageError ? inputs.error : 'transparent'
                    }`
                  }
                }),
              /*#__PURE__*/ _jsxs('div', {
...
addPropertyControls(FormSpark, {
  ...
  nameField: {
    ...
    controls: {
      ...
      value: { title: 'Value', type: ControlType.String, defaultValue: '' }
    },
